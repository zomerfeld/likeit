...
showvideo = 1
camH = 640 # 456 #* 2
camW = 344 # 245 #* 2 #640,480 by default
resizeTo =250 * 2 # Value to resize to for processing
...
for f in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	if showvideo == 1:
		# frameClone = imutils.resize(frameClone, width = screenWidth)
   		cv2.putText(frameClone, TextString, (100,250),cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255),2)		
